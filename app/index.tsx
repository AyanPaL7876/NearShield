...
export default function SplashScreen() {
  ...
  useEffect(() => {
    ...
    dotScale.value = withDelay(600, withSpring(1, {
      damping: 12,
      stiffness: 100
    }));
    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.content, containerStyle]}>
        <View style={styles.iconContainer}>
          <MaterialCommunityIcons name="city-variant" size={80} color="#4285F4" />
        </View>
        <ThemedText style={styles.title}>Smart City</ThemedText>
        <ThemedText style={styles.subtitle}>Safety & Secqurity</ThemedText>
      </Animated.View>
    </View>
  );
}
