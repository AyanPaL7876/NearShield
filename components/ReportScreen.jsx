...
//     image: 'https://media.istockphoto.com/id/656497862/photo/accident-at-a-steel-mill.jpg?s=612x612&w=0&k=20&c=iAyIw2Sb6MmypFz8Ennv21kyDHX-7cH5ZaYWfqQEZIc=',
//     user: {
//       name: 'Emma Johnson',
...
//     id: '3',
//     title: 'Water Leakage',
//     description: 'Water pipeline leakage at Park Street.',
//     time: '6 hours ago',
//     icon: 'water-drop',
//     image: 'https://www.hindustantimes.com/ht-img/img/2024/04/22/550x309/Thane--India---May-09--2023--Water-being-wasted-du_1713799075430_1713799166104.jpg',
//     user: {
//       name: 'Michael Brown',
...
//     comments: 5,
//     solved: true,
//     solution: 'The municipal plumber team arrived and fixed the broken pipe. They replaced the damaged section with a new PVC pipe and sealed all connections.',
//     currentStatus: 'Water supply restored to all affected areas. Road has been repaired and is now open for traffic.'
//   },
//   {
//     id: '4',
//     title: 'Electric Failure',
//     description: 'Power cut reported near Green Valley.',
//     time: '7 hours ago',
//     icon: 'bolt',
//     image: 'https://static.toiimg.com/thumb/msid-109681929,width-1280,height-720,resizemode-72/109681929.jpg',
//     user: {
...
const ReportScreen = () => {
  ...
  const viewComments = (report) => {
    Alert.alert('Comments', `Viewing ${report.comments} comments for ${report.title}`);
  };
        ...
        [
          ...
          { 
            ...
            onPress: () => {
              ...
              Alert.alert('Reopened', `The ${report.title} incident has been reopened.`);
            }
          }
        ]
      );
  ...
  const handleSubmitSolution = () => {
    if (!solution.trim() || !currentStatus.trim()) {
      Alert.alert('Error', 'Please fill in both the solution and current status fields.');
      return;
    }
    ...
    Alert.alert('Marked as Solved', `Thank you for providing the solution details for this ${currentReport.title} incident.`);
  };
  ...
  const renderHeader = () => (
    <View style={styles.filterContainer}>
      ...
      <View style={styles.filterButtons}>
        ...
        <TouchableOpacity 
          style={[styles.filterButton, filter === 'solved' && styles.activeFilter]} 
          onPress={() => filterReports('solved')}
        >
          <Text style={[styles.filterText, filter === 'solved' && styles.activeFilterText]}>Solved</Text>
        </TouchableOpacity>
        <TouchableOpacity 
          style={[styles.filterButton, filter === 'unsolved' && styles.activeFilter]} 
          onPress={() => filterReports('unsolved')}
        >
          <Text style={[styles.filterText, filter === 'unsolved' && styles.activeFilterText]}>Unsolved</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardContent}>
              ...
              <View style={styles.actionButtons}>
                ...
                <TouchableOpacity style={styles.actionButton} onPress={() => viewComments(item)}>
                ...
                <TouchableOpacity 
                  style={[styles.solveButton, item.solved && styles.solvedButton]} 
                ...
                >
                  ...
                  />
                  <Text style={[styles.solveButtonText, item.solved && styles.solvedButtonText]}>
